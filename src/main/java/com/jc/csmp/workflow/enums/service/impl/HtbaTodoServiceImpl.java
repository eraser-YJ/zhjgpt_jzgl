 ...
 * @Version 1.0
 */
public class HtbaTodoServiceImpl extends IWorkflowTodoService {

    private ICmContractInfoService cmContractInfoService;

    public HtbaTodoServiceImpl() {
        cmContractInfoService = SpringContextHolder.getBean(ICmContractInfoService.class);
    }
    ...
    public TodoExtendBean getByPid(String pid) {
        ...
        try {
            ...
            if (entity != null) {
                return TodoExtendBean.create(entity.getContractCode(), entity.getContractName());
            }
    ...
    public Map<String, Object> getFlowVariable(Map<String, Object> workflowBean, Object data) {
        //CmContractInfo entity = (CmContractInfo) data;
    ...
    public Integer updateWorkflow(WorkflowBean workflowBean, Map<String, Object> extendData) {
        ...
        try {
            ...
            return cmContractInfoService.updateWorkflow(entity);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return 0;
