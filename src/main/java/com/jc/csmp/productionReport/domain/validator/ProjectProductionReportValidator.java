package com.jc.csmp.productionReport.domain.validator;
 ...
 * @Version 1.0
 */
public class ProjectProductionReportValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return ProjectProductionReport.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		ProjectProductionReport v = (ProjectProductionReport) arg0;
		...
		if (v.getYearMon() != null && v.getYearMon().length() > 255) {
			arg1.reject("yearMon", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
