package com.jc.csmp.plan.ctrl.domain.validator;
 ...
 * @Version 1.0
 */
public class ProjectYearPlanCtrlValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return ProjectYearPlanCtrl.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		ProjectYearPlanCtrl v = (ProjectYearPlanCtrl) arg0;
		if (v.getId() != null && v.getId().length() > 50) {
			arg1.reject("id", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
		if (v.getSeqno() != null ) {
			arg1.reject("seqno", MessageUtils.getMessage(JC_SYS_011, new Object[]{"64"}));
		}
		if (v.getSeqnoname() != null && v.getSeqnoname().length() > 200) {
			arg1.reject("seqnoname", MessageUtils.getMessage(JC_SYS_011, new Object[]{"200"}));
		}
