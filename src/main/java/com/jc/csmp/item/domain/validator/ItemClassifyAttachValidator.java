 ...
 * @Version 1.0
 */
public class ItemClassifyAttachValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return ItemClassifyAttach.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		ItemClassifyAttach v = (ItemClassifyAttach) arg0;
		if (v.getId() != null && v.getId().length() > 50) {
			arg1.reject("id", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
		if (v.getItemAttach() != null && v.getItemAttach().length() > 255) {
			arg1.reject("itemAttach", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
		if (v.getItemId() != null && v.getItemId().length() > 255) {
			arg1.reject("itemId", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
