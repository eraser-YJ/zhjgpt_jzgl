 ...
 * @Version 1.0
 */
public class CmProjectPersonValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return CmProjectPerson.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		CmProjectPerson v = (CmProjectPerson) arg0;
		...
		if (v.getCompanyId() != null && v.getCompanyId().length() > 50) {
			arg1.reject("companyId", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
