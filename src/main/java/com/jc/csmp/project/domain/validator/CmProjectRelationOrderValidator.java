 ...
 * @Version 1.0
 */
public class CmProjectRelationOrderValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return CmProjectRelationOrder.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		CmProjectRelationOrder v = (CmProjectRelationOrder) arg0;
		...
		if (v.getSignerDept() != null && v.getSignerDept().length() > 255) {
			arg1.reject("signerDept", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
		if (v.getTitle() != null && v.getTitle().length() > 255) {
			arg1.reject("title", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
		if (v.getContent() != null && v.getContent().length() > 16383) {
			arg1.reject("content", MessageUtils.getMessage(JC_SYS_011, new Object[]{"16383"}));
		}
		if (v.getSignStatus() != null && v.getSignStatus().length() > 50) {
			arg1.reject("signStatus", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
