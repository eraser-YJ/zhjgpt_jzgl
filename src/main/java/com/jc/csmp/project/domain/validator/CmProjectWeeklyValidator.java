 ...
 * @Version 1.0
 */
public class CmProjectWeeklyValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return CmProjectWeekly.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		CmProjectWeekly v = (CmProjectWeekly) arg0;
		...
		if (v.getReportName() != null && v.getReportName().length() > 255) {
			arg1.reject("reportName", MessageUtils.getMessage(JC_SYS_011, new Object[]{"255"}));
		}
		if (v.getReportRemark() != null && v.getReportRemark().length() > 16383) {
			arg1.reject("reportRemark", MessageUtils.getMessage(JC_SYS_011, new Object[]{"16383"}));
		}
		if (v.getArrangements() != null && v.getArrangements().length() > 16383) {
			arg1.reject("arrangements", MessageUtils.getMessage(JC_SYS_011, new Object[]{"16383"}));
		}
		if (v.getFeedback() != null && v.getFeedback().length() > 16383) {
			arg1.reject("feedback", MessageUtils.getMessage(JC_SYS_011, new Object[]{"16383"}));
		}
		if (v.getUserId() != null && v.getUserId().length() > 50) {
			arg1.reject("userId", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
