 ...
 * @Version 1.0
 */
public class CmProjectVisaOrderValidator implements Validator{
	...
	public boolean supports(Class<?> arg0) {
		return CmProjectVisaOrder.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		CmProjectVisaOrder v = (CmProjectVisaOrder) arg0;
		...
		if (v.getAuditStatus() != null && v.getAuditStatus().length() > 50) {
			arg1.reject("auditStatus", MessageUtils.getMessage(JC_SYS_011, new Object[]{"50"}));
		}
		...
		if (v.getVisaReason() != null && v.getVisaReason().length() > 2000) {
			arg1.reject("visaReason", MessageUtils.getMessage(JC_SYS_011, new Object[]{"2000"}));
		}
		if (v.getVisaScope() != null && v.getVisaScope().length() > 2000) {
			arg1.reject("visaScope", MessageUtils.getMessage(JC_SYS_011, new Object[]{"2000"}));
		}
		if (v.getVisaChange() != null && v.getVisaChange().length() > 16383) {
			arg1.reject("visaChange", MessageUtils.getMessage(JC_SYS_011, new Object[]{"16383"}));
		}
