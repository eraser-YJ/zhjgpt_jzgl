...
/**
 *@ClassName SubDepartmentRoleGroupValidator
 *@Description
...
public class SubDepartmentRoleGroupValidator implements Validator {
	...
	public boolean supports(Class<?> arg0) {
		return SubDepartmentRoleGroup.class.equals(arg0);
	}
	...
	public void validate(Object arg0, Errors arg1) {
		SubDepartmentRoleGroup v = (SubDepartmentRoleGroup) arg0;
		if (v.getRoleGroupName() != null && v.getRoleGroupName().length() > 256) {
