...
public class ExcelSheetXMLHandler extends DefaultHandler {
	/**
	 ...
	 */
	public ExcelSheetXMLHandler(StylesTable styles, ReadOnlySharedStringsTable strings, SheetContentsHandler sheetContentsHandler, DataFormatter dataFormatter, boolean formulasNotResults) {
	 ...
	 * @param strings Table of shared strings
	 */
	public ExcelSheetXMLHandler(StylesTable styles, ReadOnlySharedStringsTable strings, SheetContentsHandler sheetContentsHandler, boolean formulasNotResults) {
	...
	public void endElement(String uri, String localName, String name) throws SAXException {
		...
		if (isTextTag(name)) {
			...
			case NUMBER:
				...
				if (this.formatString != null) {
					// Is it a date?
					Double dValue = Double.parseDouble(n);
					if (DateUtil.isADateFormat(formatIndex, formatString) && DateUtil.isValidExcelDate(dValue)) {
						Date d = DateUtil.getJavaDate(dValue, false);
						if (d != null) {
