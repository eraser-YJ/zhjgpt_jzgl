				...
				<form class="table-wrap form-table" id="dlhDatamodelItemForm">
					...
					<table class="table table-td-striped">
						...
						<tr >
							...
							<td class="w300" colspan="3">
								<dicex:mongoTypeDic name="itemType" id="itemType"  headName="-请选择-"  headValue=""/>	
							</td> 				
						</tr>
						<tr >							
...
<script src="${sysPath}/js/com/dlh/dlhDatamodelItem/mongo/dlhDatamodelItemForm.js" type="text/javascript"></script>
<script src="${sysPath}/js/com/dlh/dlhDatamodelItem/mongo/dlhDatamodelItem.validate.js" type="text/javascript"></script>
