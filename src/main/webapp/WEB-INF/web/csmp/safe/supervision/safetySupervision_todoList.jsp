				...
				<table class="table table-td-striped">
					<tbody>
						<tr>
							...
							<td><dic:select name="query_projectType" id="query_projectType" dictName="project_type" parentCode="csmp" defaultValue="" headType="2" headValue="" />
							</td>
						</tr>
					</tbody>
				</table>
...
<script src='${sysPath}/js/com/jc/csmp/safe/supervision/safetySupervision_todoList.js'></script>
