...
<section class="scrollable padder jcGOA-section" id="scrollable"> 
	<header class="con-header pull-in" id="header_1">
		<div class="crumbs">
			<span>项目管理</span>
			<span>变更及签证管理 > </span><span>变更管理 > </span><span>工程变更单申请</span>
		</div>
	</header>
			...
			<div>
				...
				<table class="table form-table table-td-striped">
					...
					<tr>
						...
						<td colspan="3"><input type="text" id="handleUser" name="handleUser" workFlowForm='textinput' itemName="handleUser" /></td>
					</tr>
					<tr>
...
<script src="${sysPath}/js/com/jc/csmp/project/change/projectChangeOrder_workflow_form.js" type="text/javascript"></script>
