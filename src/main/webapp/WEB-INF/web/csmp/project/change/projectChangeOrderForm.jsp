	...
	<div class="modal-dialog w900">
		<div class="modal-content">
			...
			<div class="modal-footer form-btn" style="text-align: center; width: 100%;">
				...
				<shiro:hasPermission name='projectChangeFileBtn'><button class="btn dark" type="button" id="fileBtn" onclick="lodopFunction.createFile({type: 'change', busId: $('#entityForm #id').val()})">归 档</button></shiro:hasPermission>
