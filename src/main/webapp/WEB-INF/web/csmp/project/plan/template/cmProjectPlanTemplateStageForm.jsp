...
<div class="modal fade panel" id="form-modal" aria-hidden="false">
    <div class="modal-dialog w600">
        <div class="modal-content">
            ...
            <div class="modal-body" id="moveBody" style="display: none;">
                <div id="treeDemoForm" class="ztree"></div>
            </div>
...
<script src='${sysPath}/js/com/jc/csmp/project/plan/template/cmProjectPlanTemplateStageForm.js'></script>