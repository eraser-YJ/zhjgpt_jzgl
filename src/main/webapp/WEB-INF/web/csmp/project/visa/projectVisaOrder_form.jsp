...
<section class="scrollable padder jcGOA-section" id="scrollable">
	<header class="con-header pull-in" id="header_1">
		<div class="crumbs">
			<span>项目管理</span>
			<span>变更及签证管理 > </span><span>签证管理 > </span><span>工程签证单申请</span>
		</div>
	</header>
	<section class="panel m-t-md clearfix">
		<form class="table-wrap m-20-auto" id="entityForm" style="margin-top: 0 !important;">
			<div>
				<h3 class="tc">基本信息</h3>
				...
				<table class="table form-table table-td-striped">
					<tbody>
					<tr>
						<td class="w100"><span class='required'>*</span>签证编号</td>
						<td><input type="text" id="code" name="code" workFlowForm='textinput' readonly="readonly" value="${applyCode}" itemName="code" /></td>
						<td class="w100"><span class='required'>*</span>发生时间</td>
						<td>
							<input class="datepicker-input" type="text" id="visaDate" name="visaDate" value="<%=com.jc.foundation.util.GlobalUtil.dateUtil2String(new java.util.Date(System.currentTimeMillis()), "yyyy-MM-dd") %>"
								   workFlowForm='textinput' data-pick-time="false" data-date-format="yyyy-MM-dd" itemName="visaDate" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="w100"><span class='required'>*</span>签证原因</td>
						<td colspan="3"><input type="text" id="visaReason" name="visaReason" workFlowForm='textinput' itemName="visaReason" /></td>
					</tr>
					<tr>
						<td class="w100">发生部位或范围</td>
						<td colspan="3"><textarea id="visaScope" name="visaScope" workFlowForm='textinput' itemName="visaScope" style="height: 80px;"></textarea></td>
					</tr>
					<tr>
						<td class="w100">变更签证做法及原因</td>
						<td colspan="3"><textarea id="visaChange" name="visaChange" workFlowForm='textinput' itemName="visaChange" style="height: 80px;"></textarea></td>
					</tr>
					<tr>
						<td class="w100"><span class='required'>*</span>工程量计算费用</td>
						<td colspan="3"><textarea id="projectAmount" name="projectAmount" workFlowForm='textinput' itemName="projectAmount" style="height: 80px;"></textarea></td>
					</tr>
					<tr>
						<td class="w100"><span class='required'>*</span>签证费用</td>
						<td><input type="text" id="visaAmount" name="visaAmount" workFlowForm='textinput' itemName="visaAmount" /></td>
						<td class="w100"><span class='required' id="checkedAmountMust"></span>核准费用</td>
						<td><input type="text" id="checkedAmount" name="checkedAmount" workFlowForm='textinput' itemName="checkedAmount"/></td>
					</tr>
					</tbody>
				</table>
			</div>
...
<script src='${sysPath}/js/com/jc/csmp/project/visa/projectVisaOrder_form.js' type="text/javascript"></script>
