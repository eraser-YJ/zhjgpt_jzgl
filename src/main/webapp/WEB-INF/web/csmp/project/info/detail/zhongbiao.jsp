...
<section class="scrollable padder jcGOA-section" id="scrollable">
    <header class="con-header pull-in" id="navigationMenu">
        <div class="crumbs">
            <span>项目管理</span>
            <span>工程信息管理 > </span><span>项目查看 > </span><span>中标信息</span>
        </div>
    </header>
    <section class="panel clearfix search-box search-shrinkage">
        <div style="background: #ededed;margin-top:10px;">
            ...
            <a onclick="parent.JCF.LoadPage({url: '/project/info/detailTab.action?id=${id}&p=zhongbiao&projectNumber=${projectNumber}' });" href="javascript:void(0);" class="gcxxgl gxxxgl-active">中标信息</a>
...
<script>
    $(document).ready(function(){
        $("#messages1").html("")
        $("#messages1").load(getRootPath()+"/dlh/dlhQuery/loadTableMapPage.action?objUrl=pt_winbidding_info",null,function(){
