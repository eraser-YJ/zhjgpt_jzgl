...
<section class="scrollable padder jcGOA-section" id="scrollable">
	<header class="con-header pull-in" id="navigationMenu">
		<div class="crumbs">
			<span>行业监管</span>
			<span>行业监管> </span><span>施工许可证统计</span>
		</div>
	</header>
		...
		<div class="search-line">
			<form class="table-wrap form-table" id="searchForm">
				<table class="table table-td-striped">
					<tbody>
					<tr>
						<td class="w100">施工许可证号</td>
						<td><input type="text" id="pcpBdmc" name="pcpBdmc" /></td>
						<td class="w100">工程名称</td>
...
<script src='${sysPath}/js/com/jc/csmp/projectSgxk/companyProjectsSgxkList.js?q=2'></script>
