        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    var setting = {filePath:data.filePath,type:"doc",isArchive:true,isNew:false,isOpen:false, isShowToolBar:true,isPrint:false,isReadonly:true,isSummary:true,callback:""};
                    WebOffJG.openFile(setting);
                    /*Aip.openFile({fileContent:path_+data.filePath,isFile:true,state:0,isPrint:true,isSaveToLocal:false,isSaveToService:false,type:"aip",callback:function(a){
                     window.close();
                     }});*/
                }
            });
