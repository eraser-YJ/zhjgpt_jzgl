...
<script src="${sysPath}/js/com/archive/myOperation.js"></script>
   ...
   <section class="panel clearfix">
	   ...
	   <div class="table-wrap">
	       <table id="audithisList" class="table table-striped tab_height">
	           <thead>
	               <tr>
	                   <th class="w100" style="width:15%;">名称</th>
	                   <!-- <th class="w100" style="width:6%;">操作人员</th> -->
	                   <th class="w100" style="width:12%;">操作类型</th>
	                   <th class="w100" style="width:8%;">类型</th>
	                   <th class="w100" style="width:15%;">操作时间</th>
	                   <th class="w100" style="width:12%;">操作IP</th>
