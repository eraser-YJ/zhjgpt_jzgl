...
<section class="scrollable padder jcGOA-section" id="scrollable"> 
	...
	<section class="panel m-t-md" id="body">
		...
		<div class="table-wrap">
			<table class="table table-striped tab_height first-td-tc" id="pinDepartmentTable"></table>
		</div>
...
<script src='${sysPath}/js/com/sys/pinDepartment/pinDepartmentList.js'></script>
