...
<script src="${sysPath}/js/com/sys/pinDepartment/pinDepartmentForm.js" type="text/javascript"></script>
<script src="${sysPath}/js/com/sys/pinDepartment/pinDepartment.validate.js" type="text/javascript"></script>
