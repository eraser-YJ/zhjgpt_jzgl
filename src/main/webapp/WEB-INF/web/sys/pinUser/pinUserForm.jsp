...
<script src="${sysPath}/js/com/sys/pinUser/pinUserForm.js" type="text/javascript"></script>
<script src="${sysPath}/js/com/sys/pinUser/pinUser.validate.js" type="text/javascript"></script>
