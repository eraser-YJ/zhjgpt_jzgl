...
<section class="scrollable padder jcGOA-section" id="scrollable">
	...
	<section class="panel search-shrinkage clearfix">
		<div class="search-line hide">
			<form class="table-wrap form-table" id="subDepartmentRoleGroupQueryForm">
				...
				<section class="form-btn m-b-lg">
					<button class="btn dark" type="button" id="querySubDepartmentRoleGroup">查 询</button>
	...
	<section class="panel m-t-md" id="body">
		<script>
			...
			function oTableSetButtones(source) {
				var buttonStr = "";
				var edit = "<a class=\"a-icon i-new\" href=\"#myModal-edit\" onclick=\"subDepartmentRoleGroupList.loadModuleForUpdate('"
						+ source.id
						+ "')\" role=\"button\"><i class=\"fa fa-edit2\" data-toggle=\"tooltip\" data-placement=\"top\" data-container=\"body\" data-original-title=\"编辑\"></i></a>";
				var del = "<a class=\"a-icon i-remove\" href=\"#\" onclick=\"subDepartmentRoleGroupList.deleteSubDepartmentRoleGroup('"
						+ source.id
		...
		<div class="table-wrap">
			<table class="table table-striped tab_height first-td-tc" id="subDepartmentRoleGroupTable">
				<thead>
					<tr>
						<th class="w46">
							<input type="checkbox" />
		...
		<section class="clearfix" id="footer_height">
			<section class="form-btn fl m-l">
				<a class="btn dark" role="button" id="addSubDepartmentRoleGroupButton">新 增</a>
				<button class="btn " id="deleteSubDepartmentRoleGroups" type="button">批量删除</button>
			</section>
		</section>
	</section>
	<div id="subDepartmentRoleGroupModuleDiv"></div>
</section>
</section>
<script src='${sysPath}/js/com/sys/subDepartmentRoleGroup/subDepartmentRoleGroupList.js'></script>
