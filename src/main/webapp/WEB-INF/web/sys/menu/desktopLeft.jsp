...
<body ondragstart="return false" id="desktopBody">
        ...
        <header class="header navbar-fixed-top" id="desktop_header">
            ...
            <section class="userInfo m-r-sm fr clearfix">
                ...
                <div class="topbtn fr tr m-r-sm">
                    <i class="fa fa-user2"></i><a href="javascript:void(0)" class="s-headerH" onClick="JCF.LoadPage({name : '个人信息' , url : '/sys/user/userInfo.action'});">个人资料</a>
                    <i class="fa fa-user2"></i><a href="javascript:void(0)" class="s-headerH" onclick="JCF.LoadPage({name: '密码修改', url  : '/sys/user/userPwd.action' });">密码</a>
                    <i class="fa fa-user2"></i><a href="javascript:void(0)" class="s-headerH" onClick="exit()">安全退出</a>
                </div>
            </section>
        </header>
        <section>
    ...
    <div id="birthdayDiv" class="birthday">
        ...
        <div><img alt="生日提醒" width="400" height="300"  src="${sysPath}/images/happybirthday.gif?v=54dda22b36" ></div>
    </div>
