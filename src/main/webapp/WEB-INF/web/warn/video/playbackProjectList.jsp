	...
	<header class="con-header pull-in" id="header_1">
		<c:choose>
			...
			<c:otherwise>
				<div class="crumbs">
					<span>视频监控预警</span>
					<span>视频监控预警 > </span><span>视频回放</span>
				</div>
			</c:otherwise>
		</c:choose>
	</header>
	...
	<section class="panel ">
		<div class="table-wrap">
			<section class="form-btn fl m-l">
				<a class="btn dark" role="button" id="viewBtn" style="margin: 0 !important;">查看视频回放</a>
			</section>
...
<script src='${sysPath}/js/com/jc/csmp/warn/video/playbackProjectList.js'></script>
