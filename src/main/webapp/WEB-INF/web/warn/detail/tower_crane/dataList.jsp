...
<script>
    ...
    warnInfoJsList.oTableAoColumns = [
        ...
        {mData: 'num01', sTitle: '起重量(吨)', bSortable: false},
        {mData: 'num02', sTitle: '高度(米)', bSortable: false},
        {mData: 'num03', sTitle: '幅度(度)', bSortable: false},
        {mData: 'num04', sTitle: '回转(度)', bSortable: false},
        {mData: 'num05', sTitle: '倾角(度)', bSortable: false},
        {
            mData: function (source) {
                if (source.warnStatus == 'processed') {
