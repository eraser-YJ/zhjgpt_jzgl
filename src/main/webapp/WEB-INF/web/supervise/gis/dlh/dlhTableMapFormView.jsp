...
<div class="modal fade" id="table-map-form" aria-hidden="false">
	<div class="modal-dialog w900">
		<div class="modal-content">
			...
			<div class="modal-footer form-btn">
				<button class="btn" type="button" id="tableFormDivClose">关 闭</button>
			</div>
		</div>
	</div>
</div>
<script>
	...
	dlhTableMapForm.show = function (){
		...
		$('#table-map-form').modal('show');

	};
	$(document).ready(function(){
		ie8StylePatch();

		$("#tableFormDivClose").click(function(){$('#table-map-form').modal('hide');});
	});
</script>
