...
projectInfoJsList.oTableFnServerParams = function (aoData) {
    ...
    if (projectNumberCondObj.length > 0) {
        aoData.push({"name": "projectNumber", "value": projectNumberCondObj});
    }
...
projectInfoJsList.viewFun = function () {
    var codesArr = [];
...
$(document).ready(function () {
    ...
    $('#viewBtn').click(projectInfoJsList.viewFun);
