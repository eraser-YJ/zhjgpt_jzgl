...
var KisBpmShapeSelectionCtrl = [ '$rootScope', '$scope', '$timeout', '$translate', function($rootScope, $scope, $timeout, $translate) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [{ field: 'objectId', displayName: 'Icon', width: 50, cellTemplate: ACTIVITI.CONFIG.rootPath + '/process-editor/editor-app/popups/icon-template.html?version=' + Date.now() },
