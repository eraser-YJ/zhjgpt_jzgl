    ...
    var Uploader = function () {
        function Uploader(options) {
            ...
            this.$el = function () {
                if (options && options.el) {
                    return typeof options.el == 'string' ? jQuery(options.el) : options.el;
                } else {
        ...
        _createClass(Uploader, [{
            ...
            value: function addBindEvent() {
                ...
                _this.uploader.on('beforeFileQueued', function (file) {
                    ...
                    if (response.code === '000000') {
                        ...
                        if (jQuery.isFunction(option.success)) {
                    ...
                    layer.close(_this.loadInex);
                    if (jQuery.isFunction(option.finished)) {
                ...
                //插件初始化完成回调
                if (jQuery.isFunction(option.ready)) {
            ...
            value: function addFile(file) {
                ...
                if (jQuery.isFunction(option.targetHandler)) {
                    option.targetHandler.call(_this, file);
                } else {
                    var html = _this.getTargetTemplate(file);
            ...
            value: function removeFile(file) {
                ...
                //获取webuploader队列中的附件
                var webFile = _this.uploader.getFiles();
                //删除队列中的附件
                ...
                if (jQuery.isFunction(option.delCallback)) {
            ...
            key: 'getDel',
            value: function getDel() {
                return this.delFiles.map(function (file) {
                    return file.id;
                });
            }
            /**
            ...
            key: 'getTargetTemplate',
            value: function getTargetTemplate(file) {
                var _this = this,
                    option = _this.option;
            ...
            value: function containerTemplate() {
                var _this = this,
                    option = _this.option;

                var temp = ['<div class="uploader-container">'];
